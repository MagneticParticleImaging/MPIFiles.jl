...
measTemperatures(f::MDFFile) = @keyoptional f["/measurement/sensor/temperature"] # non-standard
measDriveField(f::MDFFile) = @keyoptional f["/measurement/sensor/driveField"] # non-standard
